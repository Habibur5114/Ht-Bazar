...
@section('title') {{ $title ?? 'banner Ads create' }} @endsection
@section('content')
    <div class="mt-5">
        <main class="app-main">
                        ...
                        <div class="col-md-12 m-2">
                            <div class="card mb-4">
                                <div class="d-flex justify-content-between align-items-center m-3 ">
                                    <h3 class="card-title"><b>Create Banner Ads</b></h3>
                                ...
                                <hr>
                                <div class="card-body">
                                    <form method="POST" action="{{ route('admin.banner-ads.store') }}"
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="offer" class="form-control"
                                                        placeholder="Enter offer" value="{{ old('offer') }}">
                                                    @error('offer')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                    ...
                                                    <select class="form-select form-control" name="banner_category"  >
                                                        ...
                                                        @foreach ($categories as $category)
                                                            <option value="{{ $category->id }}"
                                                                {{ old('banner_category') == $category->id ? 'selected' : '' }}>
                                                                {{ $category->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
